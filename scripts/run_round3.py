...
a=p.parse_args()
CODE_ROOT=ROOT if a.variant=='optimized' else ROOT/'audit/round3_baseline'
...
'--flexgen-root',str(CODE_ROOT/'vendor/flexgen'),'--flexgen-kv-dir',str(ROOT/'runtime_data/pcache_c16'),
