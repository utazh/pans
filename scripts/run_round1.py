#!/usr/bin/env python3
"""Round-1 fixed P1 / uniform exact 25% budget; separate timing and profiler runs."""
...
p.add_argument('--period',type=int,choices=[1,2,4,8],default=1)
...
if a.profile!='none':
    ...
    for name in ['load_selector_keys','_load_selector_keys_sync','resolve','_resolve_impress','_resolve_entry','_update_loaded_layer_score','schedule','schedule_impress_next','schedule_impress_period','prefetch_selector_keys','resolve_deferred_impress_compute']:
...
'--plan',str(ROOT/'configs/qwen25_k025_ours.json'),
...
'--period-size','8','--subperiod-size','4','--expected-keep-ratio','0.25',
